...
O codigo do desktop contem funcionalidade de reducao local do ZIP (`desktop/main.js` + `desktop/scripts/reduce_log.py`) que permite enviar ao backend apenas relatorio reduzido.
